...
import os 
from tools_dir.arxiv_tool import *
from tools_dir.read_pdf import *
from tools_dir.write_pdf import *
...
model = ChatOpenAI(model="gpt-5.2" , api_key=open_ai_api).bind_tools(tools)
